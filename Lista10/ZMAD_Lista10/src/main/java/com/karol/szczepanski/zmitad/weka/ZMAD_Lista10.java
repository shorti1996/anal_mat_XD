...
import com.karol.szczepanski.classification.weka.WekaClassification;
import com.karol.szczepanski.classification.weka.validation.CrossValidation;
import com.karol.szczepanski.classification.weka.validation.ValidationResults;
...
public class ZMAD_Lista10 {
    ...
    static {
        try {
            ...
            // Przypożądkowuje wszystkie klasy do najbardziej popularnej - dolna granica dla wszystkich algorytmów.
