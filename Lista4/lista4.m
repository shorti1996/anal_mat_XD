...
function zadanie2
    ...
    nerwowi = [3, 3, 4, 5, 5];
    spokojni = [4, 6, 7, 9, 9];
    % h0 - nerwowi i spokojni wykonuja srednio tyle samo ruchow (œrednie takie same)
...
function zadanie3
    ...
    przed30 = [6, 7, 10, 9];
    po30 = [5, 6, 2, 3];
    % h0 - przed30 i po30 tak samo dowcipni (œrednie takie same)
...
function zadanie4
    fprintf('\nzadanie4.\n');
    % Nie mozna zastosowac testu dla prób zale¿nych. Próby s¹ niezale¿ne.
    % Trzeba by zebraæ dane ponownie np. po zmianie wyksztalcenia dla tych
    % samych osob
end
...
function zadanie6
    ...
    % nie mo¿na przeprowadziæ ttestu
end
...
function zadanie7
    ...
    nerwowi = [3, 3, 4, 5, 5];
    spokojni = [4, 6, 7, 9, 9];
    % h0 - próbki s¹ jednakowo du¿e
    % h1 - próbki nie s¹ jednakowo du¿e
    alpha = 0.05;
...
function zadanie8
    ...
    % h0 - wzrost studentów jest jednakowo du¿y
    % h1 - wzrost studentów nie jest jednakowo du¿y
    alpha = 0.05;
